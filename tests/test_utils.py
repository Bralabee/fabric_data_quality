...
class TestFileSystemHandlerIsAbfss:
    ...
    def test_is_abfss_with_abfss_root_path(self):
        ...
        assert (
            FileSystemHandler.is_abfss("abfss://mycontainer@mystorageaccount.dfs.core.windows.net/")
            is True
        )
    ...
    def test_is_abfss_with_http_path(self):
        ...
        assert (
            FileSystemHandler.is_abfss("https://storage.blob.core.windows.net/container/file.csv")
            is False
        )
    ...
    def test_is_abfss_with_wasbs_path(self):
        ...
        assert (
            FileSystemHandler.is_abfss("wasbs://container@account.blob.core.windows.net/file.csv")
            is False
        )
...
class TestFileSystemHandlerExists:
    ...
    def test_exists_abfss_without_fabric(self):
        ...
        result = FileSystemHandler.exists(
            "abfss://container@account.dfs.core.windows.net/path/file.csv"
        )
    ...
    def test_exists_abfss_with_fabric_not_exists(self, mock_mssparkutils):
        ...
        result = FileSystemHandler.exists(
            "abfss://container@account.dfs.core.windows.net/path/nonexistent.csv"
        )
...
class TestFileSystemHandlerIsDir:
    ...
    def test_is_dir_abfss_with_fabric_is_file(self, mock_mssparkutils):
        ...
        result = FileSystemHandler.is_dir(
            "abfss://container@account.dfs.core.windows.net/path/file.csv"
        )
...
class TestGetMssparkutils:
    ...
    def test_get_mssparkutils_returns_value(self):
        ...
        from dq_framework.utils import _mssparkutils, get_mssparkutils
...
class TestFabricAvailableConstant:
    ...
    def test_mssparkutils_alias(self):
        ...
        from dq_framework.utils import _mssparkutils, mssparkutils
