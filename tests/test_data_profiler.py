...
def date_column_dataframe():
    ...
    return pd.DataFrame({
        ...
        "datetime_col": pd.to_datetime(["2023-01-01", "2023-02-15", "2023-03-20", "2023-04-10", "2023-05-05"]),
...
class TestDetectColumnType:
    ...
    def test_detect_column_type_parametrized(self, col_name, expected_type):
        ...
        df = pd.DataFrame({
            col_name: list(range(100)) if 'id' in col_name.lower() or 'uniqid' in col_name.lower() 
                      else [f"val_{i}" for i in range(100)] if 'code' in col_name.lower() or 'nr' in col_name.lower()
...
class TestLooksLikeDate:
    ...
    def test_valid_date_formats(self, sample_dataframe):
        ...
        assert profiler._looks_like_date(valid_dates) == True
    ...
    def test_invalid_date_strings(self, sample_dataframe):
        ...
        invalid_dates = pd.Series([
            "not-a-date", "also-not", "nope", "wrong", "invalid"
        ])
        assert profiler._looks_like_date(invalid_dates) == False
    ...
    def test_mixed_valid_invalid_dates(self, sample_dataframe):
        ...
        mixed_dates = pd.Series([
            "2023-01-01", "not-a-date", "not-valid", "wrong", "invalid"
        ])
        assert profiler._looks_like_date(mixed_dates) == False
    ...
    def test_mostly_valid_dates(self, sample_dataframe):
        ...
        assert profiler._looks_like_date(mostly_valid) == True
    ...
    def test_date_with_timestamps(self, sample_dataframe):
        ...
        assert profiler._looks_like_date(datetime_strings) == True

    @pytest.mark.parametrize("date_series,expected", [
...
class TestGenerateExpectations:
    ...
    def test_generate_expectations_structural_only(self, sample_dataframe):
        ...
        structural_types = ['expect_table_row_count_to_be_between', 'expect_table_column_count_to_equal']
    ...
    def test_generate_expectations_custom_null_tolerance(self, dataframe_with_nulls):
        ...
        null_checks_high = [e for e in config_high_tolerance['expectations'] 
                           if e['expectation_type'] == 'expect_column_values_to_not_be_null']
        null_checks_low = [e for e in config_low_tolerance['expectations'] 
                          if e['expectation_type'] == 'expect_column_values_to_not_be_null']
...
class TestStructuralExpectations:
    ...
    def test_structural_expectations_content(self, sample_dataframe):
        ...
        row_exp = next(e for e in expectations 
        ...
        col_exp = next(e for e in expectations 
...
class TestCompletenessExpectations:
    ...
    def test_completeness_always_includes_column_exists(self, sample_dataframe):
        ...
        expectations = profiler._generate_completeness_expectations(
            'name', col_info, 5.0, 'medium'
        )
        
        exists_exp = [e for e in expectations 
    ...
    def test_completeness_null_check_below_tolerance(self, sample_dataframe):
        ...
        null_checks = [e for e in expectations 
                       if e['expectation_type'] == 'expect_column_values_to_not_be_null']
    ...
    def test_completeness_id_column_high_severity(self, sample_dataframe):
        ...
        null_check = next((e for e in expectations 
                          if e['expectation_type'] == 'expect_column_values_to_not_be_null'), None)
        if null_check:
...
class TestValidityExpectations:
    ...
    def test_validity_id_uniqueness(self, sample_dataframe):
        ...
        unique_exp = [e for e in expectations 
    ...
    def test_validity_numeric_range(self, numeric_column_dataframe):
        ...
        range_exp = [e for e in expectations 
    ...
    def test_validity_categorical_value_set(self, categorical_dataframe):
        ...
        set_exp = [e for e in expectations 
    ...
    def test_validity_string_length(self, sample_dataframe):
        ...
        length_exp = [e for e in expectations 
...
class TestPrintSummary:
    ...
    def test_print_summary_long_column_name(self, capsys):
        ...
        df = pd.DataFrame({
            'this_is_a_very_long_column_name_that_exceeds_limit': [1, 2, 3]
        })
        profiler = DataProfiler(df)
        profiler.print_summary()
...
class TestEdgeCases:
    ...
    def test_special_numeric_values(self):
        ...
        df = pd.DataFrame({
            'values': [1.0, float('inf'), float('-inf'), 100.0, np.nan]
        })
        profiler = DataProfiler(df)
        profile = profiler.profile()
    ...
    def test_very_large_numbers(self):
        ...
        df = pd.DataFrame({
            'big_nums': [1e308, -1e308, 1e-308, 0, 1]
        })
        profiler = DataProfiler(df)
        profile = profiler.profile()
...
class TestIntegration:
    ...
    def test_full_workflow(self, sample_dataframe):
        ...
        config = profiler.generate_expectations(
            validation_name="integration_test",
