...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "Quick commands:"
    echo "  python scripts/profile_data.py --help              - Show help"
    echo "  python scripts/profile_data.py data/file.csv       - Profile single file"
    echo "  python scripts/profile_data.py data/ --workers 4   - Profile directory in parallel"
